...
import { Mail, Phone, Globe, ArrowRight, Users, Award, Sparkles, Shield, Zap, Target, Star, Cloud, Bot, BarChart3, Lock, Github } from 'lucide-react'
...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'LinkedIn', href: 'https://linkedin.com/company/yatisphere', icon: LinkedInIcon },
    { name: 'Twitter', href: 'https://twitter.com/yatisphere', icon: TwitterIcon },
    { name: 'GitHub', href: 'https://github.com/yatisphere', icon: Github }
  ]
